 ...
 * @param  position
 */
void Light::setPosition(glm::vec4 position) { this->position = position; }
 ...
 */
void Light::setDirection(glm::vec4 direction) { this->direction = direction; }

/**
 * Setter for light angle
 * @param  angle light angle
 */
void Light::setAngle(float angle) { this->angle = angle; }
/**
 * Getter for light angle
 * @return light angle
 */
float Light::getAngle() const { return this->angle; }
/**
 * Getter for light radius
 * @return light radius
 */
float Light::getRadius() const { return this->radius; }
/**
 * Setter for light radius
 * @param light radius
 */
void Light::setRadius(float radius) { this->radius = radius; }
/**
 * Getter for light cutoff
 * @return light cutoff
 */
float Light::getCutoff() const { return this->cutoff; }
