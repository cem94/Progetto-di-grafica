...
/**
* Class responsible for storing a single 3D object (including its vertices, texturing coordinates, and a reference to the used material).
* The class includes the necessary methods for transferring data to OpenGL.
*/
