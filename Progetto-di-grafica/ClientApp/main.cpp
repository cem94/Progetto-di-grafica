...
void keyboardCallback(unsigned char key, int mouseX, int mouseY) {
  switch (key) {
      // CosÏ dovrebbe essere comoda da usare//
    case '1':
...
void specialCallback(int key, int x, int y) {
  ...
  // TODO:: GREG si se modifica qualcosa graficamente, devi far vedere i
  // cambiamenti.
  engine->redisplay();
}
...
int main(int argc, char* argv[]) {
  ...
  // TODO:: GREG funziona anche senza
